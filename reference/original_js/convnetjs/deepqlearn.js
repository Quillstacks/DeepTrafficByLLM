  ...
  Brain.prototype = {
    ...
    random_action: function(seeded) {
      ...
      if(this.random_action_distribution.length === 0) {
        // 2017-12-04 jack
        return typeof seeded === 'undefined' ?  convnetjs.randi(0, this.num_actions) : Math.floor(this.seeded_random_generator.nextFloat())*this.num_actions;
      } else {
        // okay, lets do some fancier sampling:
        // 2017-12-04 jack
        var p = typeof seeded === 'undefined' ? convnetjs.randf(0, 1.0): this.seeded_random_generator.nextFloat();
        var cumprob = 0.0;
    ...
    forward: function(input_array) {
      ...
      if(this.forward_passes > this.temporal_window) {
        ...
        var net_input = [];
        // 2017-12-04 jack
        action = this.random_action(true);
      }
